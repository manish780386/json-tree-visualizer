...
function activate(context) {
    context.subscriptions.push(vscode.commands.registerCommand('jsonVisualizer.openPanel', () => {
        openOrRevealPanel(context);
    }));
    context.subscriptions.push(vscode.commands.registerCommand('jsonVisualizer.visualizeSelection', () => {
    ...
    context.subscriptions.push(vscode.commands.registerCommand('jsonVisualizer.fetchApi', async () => {
...
function openOrRevealPanel(context) {
    ...
    panel = vscode.window.createWebviewPanel('jsonVisualizer', '🌳 JSON Visualizer Pro', vscode.ViewColumn.Beside, { enableScripts: true, retainContextWhenHidden: true });
